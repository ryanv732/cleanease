...
?>
	...
	<form action="index.php?option=com_digistore" name="adminForm" method="post">
...
<?php
	...
	$link = JRoute::_("index.php?option=com_digistore&controller=digistoreCustomers&task=edit&cid=".$id);
