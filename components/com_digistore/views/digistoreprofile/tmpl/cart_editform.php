...
function validateInput(input){
	...
	if(value != ""){
		var myAjax = new Ajax('index.php?option=com_digistore&controller=digistoreCart&format=raw&task=validate_input&input='+input+'&value='+value,
				   {
...
<?php
	...
	$login_link = JRoute::_("index.php?option=com_digistore&controller=digistoreProfile&task=login&returnpage=cart&tmpl=component&returnpage=cart&graybox=true");
?>
...
<?php
	/*if($this->askforbilling == 0){
		...
		$configs = new digistoreModeldigistoreConfig();
		...
		<tr>
			...
			<td>
				<?php
					...
					echo digistoreHelper::get_store_province($customer, false);
				?>
			</td>
		</tr>
