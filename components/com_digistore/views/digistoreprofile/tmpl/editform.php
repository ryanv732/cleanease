...
<div class="digistore_form_account">
...
<form action="index.php?option=com_digistore" method="post" name="adminForm" id="adminForm" onsubmit="return validateForm();" class="form-horizontal">
	...
	<?php if($configs->askforbilling == 1){ ?>
	...
	{
		$configs->askforship = 0;
	} ?>

<?php if ($configs->askforship == 1): ?>
