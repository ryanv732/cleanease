				...
				<tr id="license<?php echo $license->id; ?>">
					...
					<td>
						...
						<?php
							...
							$htmls = $dispatcher->trigger( 'onAfterDigiStoreShowDownloadLink', array( 'com_digistore.showdownload' , $license->id, $license->productid, $plan_boolean, $show_download_link ) );
							if(count($htmls)){
								?>
