...
$db = JFactory::getDBO();
$sql = "select `id` from #__menu where `link`='index.php?option=com_digistore&view=digistorelicenses' and `menutype`='Digistore-Menu'";
$db->setQuery($sql);
$db->query();
$Itemid = intval($db->loadResult());

$link = JRoute::_("index.php?option=com_digistore&controller=digistoreLicenses&task=saveDomain&action=saveDomain&Itemid=".$Itemid);
