...
<table  class="adminlist" width="100%"  border="0" cellpadding="3" cellspacing="0" bordercolor="#cccccc" style="border-collapse: collapse">
	...
	<tr>
	<th align="left">
		<b><?php echo trim($configs->store_name) != "" ? $configs->store_name : ""; ?></b>
	</th>

	<th style="font-weight:normal" align="right">
		<?php echo JText::_("DSMYORDER")." #".$order->id; ?>
		<br />
		<?php echo JText::_("DSDATE")." ".date( $configs->time_format, $order->order_date);?>
	</th>
<tr><tr>

	<td align="left">
		<?php echo trim($configs->store_url != "") ? "&nbsp;&nbsp;URL: ".$configs->store_url : ""; ?><br />
		<table>
			<?php
			...
			<tr>
				...
				<td>
					...
					<?php endif; ?>
					<?php echo $configs->state;?>
				</td>
			</tr>
			<?php
			}

			if(trim($configs->country) != ""){
			?>
			<tr>
				<td></td>
				<td>
...
?>
	<tr class="row<?php echo $k;?> sectiontableentry<?php echo ($i%2 + 1);?>">
		...
		<td>
			<span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($prod->price, $prod->currency, true, $configs);?></span>
		</td>

		<td>
			<span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($prod->price - $prod->amount_paid, $prod->currency, true, $configs);?></span>
		</td>
		...
		<td>
			...
			?>
			<span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($prod->amount_paid, $prod->currency, true, $configs);?></span>
		</td>
...
?>
	...
	<tr>
		...
		<td><span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($order->amount, $prod->currency, true, $configs);?></span></td>
	</tr>
...
?>
	<tr>
		...
		<td><span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($order->shipping, $prod->currency, true, $configs);?></span></td>
	</tr>
<?php
	}
?>
...
?>
	<tr>
		...
		<td><span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($order->promocodediscount, $prod->currency, true, $configs);?></span></td>
	</tr>
<?php
	}
?>
	...
	<tr>
		...
		<td><span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($order->tax, $prod->currency, true, $configs);?></span></td>
	</tr>
	...
	<tr>
		...
		?>
		<td><span style="white-space:nowrap;"><?php echo digistoreHelper::format_price($total, $prod->currency, true, $configs);?></span></td>
	</tr>
</tbody>
