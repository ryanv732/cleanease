...
function getStates()
{
	var url1 = '<?php echo JURI::root();?>index.php?option=com_digistore&controller=digistorecart&task=getcountries&tmpl=component&format=raw&cardstate=<?php echo $cardstate;?>&ct=' + jQuery('#cardcountry').val();
	jQuery.ajax(
			{
				url:url1,
				type:'GET',
...
<div class="digistore" style="<?php echo $configs->shopping_cart_style ? 'width: 70%;margin-left: auto;margin-right: auto;padding: 20px 0 0 0;background: #fff;' : ''; ?>">
	<div class="container-fluid">
		...
		<div style="background:#f7f7f7;border-radius:5px;-webkit-border-radius:5px;-moz-border-radius:5px;padding-top:10px;">
			<div class="row-fluid">
				...
				<div class="span6">
					<img style="float:right;margin-right:10px;" src="<?php echo JURI::root();?>/components/com_digistore/assets/images/we-accept.png" alt="" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span6">
				<h4 style="color:#666;"><img src="<?php echo JURI::root();?>/components/com_digistore/assets/images/lock.png" align="absmiddle" style="margin-right:10px;" alt="" /> Credit Card Information:</h4>
			</div>
			<div class="span6">
						...
						<section id="cvv" class="modal hide">
						  <div id="printThis">
							...
							<div class="modal-body">
								<img src="<?php echo JURI::root();?>components/com_digistore/assets/images/cvv3.jpg" style="max-width: 98%;">
							</div>
						  </div>
						</section>
		...
		<div class="row-fluid">
			<div class="span6">
				<h4 style="color:#666;"><img src="<?php echo JURI::root();?>/components/com_digistore/assets/images/home.png" align="absmiddle" style="margin-right:10px;" alt="" /> Billing Information:</h4>
			</div>
		</div>
		<div style="background:#f7f7f7;border-radius:5px;-webkit-border-radius:5px;-moz-border-radius:5px;padding-top:25px;">
			<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls" style="margin-left:5px;"><input class="inputbox required" id="email" type="text" name="email" tabindex="8" size="35" style="width:190px;" value="<?php echo $email != '' ? $email : $vars->user_email;?>" /></div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
