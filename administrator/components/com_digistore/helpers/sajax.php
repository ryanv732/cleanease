...
//print_r($_SERVER["REQUEST_URI"]);
		$sajax_remote_uri = digistoreAdminHelper::getLiveSite();//$_SERVER["REQUEST_URI"];
		$sajax_remote_uri .= "/index.php?option=com_digistore";
		if (!strpos( $sajax_remote_uri, "?option=com_digistore")) {
			if (strpos( $sajax_remote_uri, "?")) {
							$sajax_remote_uri.='&option=com_digistore';
			} else {
							$sajax_remote_uri.='?option=com_digistore';
			}
		} 
		return $sajax_remote_uri."&no_html=1&controller=digistoreSajax";
	}
