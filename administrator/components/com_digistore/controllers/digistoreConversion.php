...
class digistoreAdminControllerdigistoreConversion extends digistoreAdminController {
	...
	function askParams() {
		...
		$content = '
			<form action="index.php" method="POST" enctype="multipart/form-data">
				...
				<input type="hidden" name="controller" value="digistoreConversion" />
...
function convert_customers() {
	...
	$data = array();
	$new_udata = array();
	$sql = "select * from ".$j1015.".#__digistore_customer c, ".$j1015.".#__users u where c.userid = u.id";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_customers(`".implode("`,`", array_keys($cdata))."`) values ";
...
function convert_products(){ 
	...
	$db = $database;
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_product";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_products(`".implode("`,`", array_keys($pdata))."`) values ";
	$q = "insert into #__digistore_product_categories(`productid`, `catid`) values ";
	$fdata = array();
	if(count($p_old) > 0)
...
function convert_featured(){
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_featuredproducts";
	$db->setQuery($sql);
	$p_old = $db->loadObjectList();
	$pdata = array();
	$pdata['productid'] = '';
	...
	$sql = "insert into #__digistore_featuredproducts(`".implode("`,`", array_keys($pdata))."`) values ";
	if(count($p_old) > 0)
	foreach ($p_old as $i => $v){
...
function convert_productfields(){
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_prodfields";
	$db->setQuery($sql);
	$p_old = $db->loadObjectList();
	$pdata = array();
	$pdata['productid'] = '';
	...
	$sql = "insert into #__digistore_prodfields(`".implode("`,`", array_keys($pdata))."`) values ";
	if(count($p_old) > 0)
	foreach ($p_old as $i => $v){
		$pdata['productid'] = $v->productid;
...
function convert_fields(){
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_customfields";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_customfields(`".implode("`,`", array_keys($fdata))."`) values ";
	if(count($f_old) > 0)
...
function convert_promos(){
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_promocodes";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_promocodes(`".implode("`,`", array_keys($prdata))."`) values ";
	if(count($pr_old) > 0)
...
function convert_categories() {
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_categories";
	$db->setQuery($sql);
	$c_old = $db->loadObjectList();
	$cdata = array();
	...
	$cdata['images'] = null;
	$cdata['params'] = null;
	$sql = "insert into #__digistore_categories(`".implode("`,`", array_keys($cdata))."`) values ";
	if(count($c_old) > 0)
	foreach ($c_old as $i => $v){
...
function convert_orders() {
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_orders";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_orders(`".implode("`,`", array_keys($odata))."`) values ";
	if(count($o_old) > 0)
...
function convert_licenses() {
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_licenses";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_licenses(`".implode("`,`", array_keys($ldata))."`) values ";
	if(count($l_old) > 0)
...
function convert_lfields() {
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_licensefields";
	$db->setQuery($sql);
	...
	$sql = "insert into #__digistore_licensefields(`".implode("`,`", array_keys($lfdata))."`) values ";
	if(count($lf_old) > 0)
...
function convert_lprodfields() {
	...
	$data = array();
	$sql = "select * from ".$j1015.".#__digistore_licenseprodfields";
	$db->setQuery($sql);
	$lf_old = $db->loadObjectList();
	$lfdata = array();
	...
	$sql = "insert into #__digistore_licenseprodfields(`".implode("`,`", array_keys($lfdata))."`) values ";
	if(count($lf_old) > 0)
	foreach ($lf_old as $i => $v){
		foreach ($lfdata as $i1 => $v1) {
			$lfdata[$i1] = $v->$i1;
