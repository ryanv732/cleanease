...
class digistoreAdminControllerdigistoreProductClasses extends digistoreAdminController {
	var $_model = null;
	...
	function __construct () {
		...
		$this->_model = $this->getModel("digistoreProductClass");
	}

	function listClasses() {
	   	JRequest::setVar ("view", "digistoreProductClasses");
		$view = $this->getView("digistoreProductClasses", "html");
	...
	function save(){
		...
		$link = "index.php?option=com_digistore&controller=digistoreProductClasses";
	...
	function apply(){
		...
		$link = "index.php?option=com_digistore&controller=digistoreProductClasses&task=edit&cid[]=".intval($id);
		$this->setRedirect($link, $msg);
	}
