...
<table>
	...
	<tr>
		<td align="right">
			<a class="modal digi_video" rel="{handler: 'iframe', size: {x: 750, y: 435}}" href="index.php?option=com_digistore&controller=digistoreAbout&task=vimeo&id=38437490">
				<img src="<?php echo JURI::base(); ?>components/com_digistore/assets/images/icon_video.gif" class="video_img" />
				<?php echo JText::_("COM_DIGISTORE_VIDEO_LANG_MANAGER"); ?>				  
			</a>
		</td>
	</tr>
</table>
...
<?php 
	for ($i = 0; $i < $n; $i++):
		...
		$link_fe = JRoute::_("index.php?option=com_digistore&controller=digistoreLanguages&task=editFE&cid[]=".$id);
		$link_be = JRoute::_("index.php?option=com_digistore&controller=digistoreLanguages&task=editBE&cid[]=".$id);
...
<?php 
	for ($i = 0; $i < $mn; $i++):
		...
		$link_fe = JRoute::_("index.php?option=com_digistore&controller=digistoreLanguages&task=editML&cid[]=".strtolower($language->fefilename));
?>
	<tr class="row<?php echo $k;?>"> 
<!--		 	<td>
		 			<?php //echo $checked;?>
