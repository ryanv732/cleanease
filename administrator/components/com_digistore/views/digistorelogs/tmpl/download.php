								...
								<td>
									<?php 
										...
										if(($today_day == $email_day) && ($today_month == $email_month) && ($today_year == $email_year)){
											echo JText::_("VIEWSTATTODAY")." (".date($configs->time_format, $email_date_int).") ".JText::_("DIGI_AT")." ".date("H:i A", $email_date_int)." (PST)";
										}
										elseif((($today_day-1) == $email_day) && ($today_month == $email_month) && ($today_year == $email_year)){
											echo JText::_("VIEWSTATYESTODAY")." (".date($configs->time_format, $email_date_int).") ".JText::_("DIGI_AT")." ".date("H:i A", $email_date_int)." (PST)";
										}
										else{
											echo strftime("%A", $email_date_int)." (".date($configs->time_format, $email_date_int).") ".JText::_("DIGI_AT")." ".date("H:i A", $email_date_int)." (PST)";
										}
									?>
								</td>
							</tr>
