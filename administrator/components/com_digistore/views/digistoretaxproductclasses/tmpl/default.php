...
<td colspan="5"><?php echo $this->pagination->getListFooter(); ?></td>
	...
	<form id="adminForm" action="index.php" name="adminForm" method="post">
		...
		<input type="hidden" name="controller" value="digistoreTaxProductClasses" />
	</form>
...
//	for ($i = 1; $i <= $n; $i++):
	...
	foreach ($this->pclasses as $i => $v):
		...
		$link = JRoute::_("index.php?option=com_digistore&controller=digistoreTaxProductClasses&task=edit&cid[]=".$id);
