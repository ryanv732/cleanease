  ...
  <tr class="row3">
	<td><b><?php echo _PHP_VERSIONS?>
	  ...
	  <table width="100%"  border="0" cellspacing="2" cellpadding="0">
		<tr>
		  <td width="8%"><a href="http://www.ijoomla.com/tutorials/magazine/versionphp.htm" target="_blank"><img src="<?php echo $mosConfig_live_site;?>/components/com_digistore/assets/images/icon_video.gif" width="19" height="12" border="0"></a></td>
...
<?php
$mosConfig_live_site = digistoreAdminHelper::getLiveSite();
?>
	...
	<script language="javascript" type="text/javascript" src="<?php echo $mosConfig_live_site?>/includes/js/overlib_hideform_mini.js"></script>
	  ...
	  <a style="vertical-align:top" href="javascript: void(0);" onMouseOver="return overlib('<img src=\'<?php echo $mosConfig_live_site."/components/com_digistore/assets/images/sysinfo.jpg"; ?>\' />', CAPTION, '<?php echo _WHEREINFO; ?>', BELOW, LEFT);" onMouseOut="return nd();">
			<img src="<?php echo $mosConfig_live_site."/components/com_digistore/assets/images/tooltip.png";?>" width="12" height="12" border="0" alt="<?php echo _WHEREINFO; ?>" />
		</a>
...
<input name="option" type="hidden" value="com_digistore">
<input name="controller" type="hidden" value="digistoreLicenses" />
