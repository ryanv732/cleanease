...
<script language="javascript" type="text/javascript">
	...
	function addNote(area_id, gen_number){
		...
		url = 'components/com_digistore/assets/js/functions.php?task=addnote&licid='+licenseId+'&text='+digiEscapeHtml(text)+'&expire='+expire;
		var req = new Request.HTML({
			...
			onComplete: function(response){
				...
				document.getElementById(delete_id).innerHTML = '<a href="index.php?option=com_digistore&amp;controller=digistoreLicenses&amp;task=deletenote&amp;cid[]='+licenseId+'&amp;note='+response+'">Delete</a>';
			}
		}).send();
	}
		...
		<table>
			<tr>
				<td colspan="5" align="right">
					<a class="modal digi_video" rel="{handler: 'iframe', size: {x: 750, y: 435}}" href="index.php?option=com_digistore&controller=digistoreAbout&task=vimeo&id=38437538">
						<img src="<?php echo JURI::base(); ?>components/com_digistore/assets/images/icon_video.gif" class="video_img" />
						<?php echo JText::_("COM_DIGISTORE_VIDEO_LICENSES_MANAGER"); ?>				  
					</a>
				</td>
			</tr>
		</table>	   
		...
		<table class="admintable" cellpadding="0" cellspacing="3" border="0">
			...
			<tr>
				...
				<td>
						...
						<?php
							echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEID_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
						?>
				</td>
			</tr>
			<?php endif;?>
			<tr>
				...
				<td nowrap="nowrap">
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEPUBLISH_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			...
			<tr>
				...
				<td>
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEPRODUCT_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			...
			<tr>
				...
				<td><?php
					...
					if ($lists['subcription']->duration_count != -1) {
						echo digistoreAdminHelper::getDurationType($lists['subcription']->duration_count, $lists['subcription']->duration_type);
					} else {
						echo JText::_("DS_UNLIMITED");
					}
					echo "&nbsp;".JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEPLAN_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
				?></td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSECUSTOMER_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<a href="index.php?option=com_digistore&controller=digistoreOrders&task=show&cid[]=<?php echo $license->orderid; ?>&tmpl=component" class="modal" rel="{handler: 'iframe', size: {x: 750, y: 435}}"><?php echo $license->orderid; ?></a>
					<input type="hidden" name="orderid" value="<?php echo $license->orderid;?>"/>
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEORDER_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<span id="cancelled_amount_lbl" style="<?php echo (($license->cancelled == 0 )?'display:none;':''); ?>"><?php echo JText::_("VIEWLICAMOUNTPAID") . ' ' . digistoreAdminHelper::get_currency($configs->currency);?></span>
					...
					<?php
						echo JHTML::tooltip(JText::_("LICENSE_CANCELLED_TOOLTIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
					...
					<table id="tableplain" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td>
								...
								<?php
									echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSEDOMAIN_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
								?>
							</td>
						</tr>
					</table>
			...
			<tr>
				<td>
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_LICENSENOTES_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<table id="tablenotes" cellpadding="0" cellspacing="0">
						...
						<tr valign="top">
							...
							<td>
								<a href="index.php?option=com_digistore&controller=digistoreLicenses&task=deletenote&cid[]=<?php echo $cid; ?>&note=<?php echo $licnote->id; ?>">Delete</a>
							</td>
						</tr>
						<?php } ?>
					</table>
