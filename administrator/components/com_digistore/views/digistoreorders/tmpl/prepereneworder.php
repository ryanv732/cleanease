...
$ajax = <<<EOD
	...
	window.addEvent('domready', function(){
		...
		$('buttonaddproduct').addEvent('click', function(e) {
			...
			var url = "index.php?option=com_digistore&controller=digistoreOrders&task=productitem&userid={$this->cust->id}&no_html=1";
	...
	function changePlain() {
		...
		var url = "index.php?option=com_digistore&controller=digistoreOrders&task=calc&userid={$this->cust->id}&no_html=1&jsonString="+jsonString;
	...
	function show_licences_renew(id) {
		...
		if (type == 'renewal') {
			...
			// License
			var url = "index.php?option=com_digistore&controller=digistoreLicenses&task=licenseitem&hid="+id+"&pid="+pid+"&userid={$this->cust->id}&type="+type+"&no_html=1";
			...
			var req = new Request.HTML({
				...
				onComplete: function(response){
					...
					if(nochange){
						var url = "index.php?option=com_digistore&controller=digistorePlans&task=planitem&hid="+id+"&pid="+pid+"&userid={$this->cust->id}&type="+type+"&no_html=1";
						var req = new Request.HTML({
							method: 'get',
							url: url,
							data: { 'do' : '1' },
...
$doc->addStyleSheet("components/com_digistore/assets/css/digistore.css");
...
<form id="adminForm" action="index.php" method="post" name="adminForm">
	<table width="100%">
		<tr>
			...
			<td>
				<a href="index.php?option=com_digistore&controller=digistoreOrders&task=checkcreateuser&usertype=3">Change</a>
			</td>
		</tr>
		<tr>
...
<!-- /Products -->
		...
		<tr>
			...
			<td style="border-top:1px solid #ccc;padding-top:5px;" id="payment_method">
				...
				<?php
					echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERPAYMETHOD_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
				?>
			</td>
			<td style="border-top:1px solid #ccc;padding-top:5px;"></td>
		</tr>
		<tr>
			...
			<td>
				...
				<?php
					echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERPROMOCODE_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
				?>
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERAMOUNT_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
			</td>
		</tr>
		<tr>
			...
			<td>
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERTAX_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERAMOUNTPAID_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
			</td>
		</tr>
