	...
	<table width="100%">
		<tr>
			...
			<td style="border-top:1px solid #ccc;padding-top:5px;">
				...
				<div><div class="blank" style="padding:0">
					<input type="button" class="btn btn-small" onclick="javascript:grayBoxiJoomla('index.php?option=com_digistore&controller=digistoreProducts&task=selectProducts&id=<?php echo $id_rand; ?>&userid=<?php echo $user_id; ?>&tmpl=component', 600, 400)" value="<?php echo JText::_('DIGI_SELECT')?>" />
					<?php
		...
		<tr id="subscr_type_<?php echo $id_rand; ?>" style="display:none;">
			...
			?>
					...
					<td>
						...
						<?php
							echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERSUBSCRTYPE_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
						?>
					</td>
					<td></td>
			<?php
		...
		<tr id="subscr_plan_<?php echo $id_rand; ?>" style="display:none;">
			...
			<td>
				<?php echo $this->plans; ?>
				<?php
					echo JHTML::tooltip(JText::_("COM_DIGISTORE_ORDERSUBSCRPLAN_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
				?>
			</td>
			<td></td>
		</tr>
