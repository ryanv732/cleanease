...
?>
	<tr class="row<?php echo $k;?> sectiontableentry<?php echo ($i%2 + 1);?>"> 
		...
		<td>
			<?php echo digistoreAdminHelper::format_price($prod->price, $prod->currency, true, $configs);?>
		</td>

		<td>
			<?php echo digistoreAdminHelper::format_price($prod->price - $prod->amount_paid, $prod->currency, true, $configs);?>
		</td>

		<td>
			<?php echo digistoreAdminHelper::format_price($prod->amount_paid, $prod->currency, true, $configs);?>
		</td>
...
<tr><td colspan="5" ></td>
	...
	<td><?php echo digistoreAdminHelper::format_price($order->amount - $order->tax - $order->shipping, $prod->currency, true, $configs);?></td></tr>
...
<tr>
	...
	<td><?php echo digistoreAdminHelper::format_price($refunds, $prod->currency, true, $configs); ?></td>
</tr>
<?php endif;?>
...
<tr>
	...
	<td><?php echo digistoreAdminHelper::format_price($chargebacks, $prod->currency, true, $configs); ?></td>
</tr>
<?php endif;?>
<tr><td colspan="5"></td>
	...
	<td><?php
		...
		echo digistoreAdminHelper::format_price($order->amount, $prod->currency, true, $configs);?></td></tr>
</tbody>
