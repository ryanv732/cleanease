...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<legend><?php echo JText::_('VIEWATTRIBATTRSETTINGS');?></legend>
		...
		<td>
			...
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ATTRIBNAME_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
		</td>
		</tr>
			   <tr>
		...
		<td>
			...
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ATTRIBOPTION_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
		</td>
		</tr>
		...
		<td>
			...
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ATTRIBPUBLISH_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
		</td>
		</tr>
			 <tr>
		...
		<td>
			...
			<?php
				echo JHTML::tooltip(JText::_("COM_DIGISTORE_ATTRIBSIZE_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
			?>
		</td>
		</tr>
		 </table>
