		...
		<tr>
			...
			<td style="border-top:1px solid #ccc;padding-top:5px;">
				...
				<div><div class="blank" style="padding:0">
					<input type="button" class="btn btn-small" onclick="javascript:grayBoxiJoomla('index.php?option=com_digistore&controller=digistoreProducts&task=selectProducts&id=<?php echo $id_rand; ?>&userid=<?php echo $user_id; ?>&tmpl=component&type=<?php echo $type; ?>', 600, 400)" value="<?php echo JText::_('DIGI_SELECT')?>" />
					<?php
