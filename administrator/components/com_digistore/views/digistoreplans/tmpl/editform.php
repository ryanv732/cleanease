...
<form id="adminForm" action="index.php" name="adminForm" method="post">
	...
	<fieldset>
		...
		<table>
			<tr>
				<td align="right">
					<a class="modal digi_video" rel="{handler: 'iframe', size: {x: 750, y: 435}}" href="index.php?option=com_digistore&controller=digistoreAbout&task=vimeo&id=38440227">
						<img src="<?php echo JURI::base(); ?>components/com_digistore/assets/images/icon_video.gif" class="video_img" />
						<?php echo JText::_("COM_DIGISTORE_VIDEO_PLAINS_MANAGER"); ?>				  
					</a>
				</td>
			</tr>
		</table>
		...
		<table>
			<tr>
				...
				<td>
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_PLANSNAME_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_PLANSTERMS_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<?php
						echo JHTML::tooltip(JText::_("COM_DIGISTORE_PLANSPUBLISH_TIP"), '', '',  "<img src=".JURI::root()."administrator/components/com_digistore/assets/images/tooltip.png />", '', '', 'hasTip');
					?>
				</td>
			</tr>
		</table>
	...
	<input type="hidden" name="controller" value="digistorePlans" />
