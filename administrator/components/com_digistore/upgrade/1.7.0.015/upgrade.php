...
*/
	...
	$configs015 = $this->getTableData('#__digistore_settings', 'id = 1');
	...
	$this->updateTable('#__digistore_settings', $config_set_default_value015, 'id=1');

	$products_015 = $this->getTableData('#__digistore_products', 'images <> ""', '*', 'objectlist');
	...
	foreach( $products_015 as $product015 ) {
		...
		if ( !empty($image) ) {
			...
			require_once JPATH_ROOT . DS . 'administrator' . DS . 'components' . DS . 'com_digistore' . DS . 'libs' . DS . 'thumbnail.inc.php';
			...
			if (file_exists($image)) {
				...
				$dest_file = JPATH_ROOT . DS . "images" . DS . "stories" . DS .  "digistore" . DS . "products" . DS .  $filename;
				$thumb_file = JPATH_ROOT . DS . "images" . DS . "stories" . DS .  "digistore" . DS . "products" . DS . "thumb" . DS .  $filename;
				...
				$this->updateTable('#__digistore_products', $fields015, 'id='.$product015->id);
