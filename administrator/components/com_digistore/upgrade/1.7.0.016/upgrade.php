...
$dest_file016  = JPATH_ROOT . DS . "images" . DS . "stories" . DS .  "digistore" . DS . "categories" . DS;
$thumb_file016 = JPATH_ROOT . DS . "images" . DS . "stories" . DS .  "digistore" . DS . "categories" . DS . "thumb" . DS;
...
*/
$categories016 = $this->getTableData('#__digistore_categories', "image <> ''", '*', 'objectlist');
...
$configs016 = $this->getTableData('#__digistore_settings', 'id = 1');

foreach ( $categories016 as $cat16 ) {

	$image = str_replace('images/stories/digistore/categories/','',$cat16->image);
	...
	$this->updateTable( '#__digistore_categories', $fields16, 'id='.$cat16->id );
}
